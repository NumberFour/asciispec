...
Attributes::
* *target:* The project prefix followed by a hyphen and the task number or ID (e.g. N4JS-2773).
...
[source,asciidoc]
----
:task_def_N4JS-: GitHub;IDE Bugs;https://github.com/NumberFour/N4JS/issues/${TASK_ID};icons/github.png;N4JS-${TASK_ID}
:task_def_AS-: Jira;AsciiSpec Bugs;https://github.com/NumberFour/asciispec/issues/${TASK_ID};icons/github.png;AS-${TASK_ID}
----
...
ifdef::env-github[]
AsciiDoc was decided as a suitable syntax for documentation. ``+++task:N4JS-35[title=AsciiDoc Research]+++``

AsciiDoc was decided as a suitable syntax for documentation. https://jira.numberfour.eu/browse/N4JS-35[image:../examples/icons/jira.png[]N4JS-35]

---

A bug has already ``+++task:AS-35[]+++`` been filed...

A bug has already been filed... https://github.com/NumberFour/n4js/issues/135[image:../examples/icons/github.png[]AS-35]
endif::[]
...
Jira Task: ::
[example]
AsciiDoc was decided as a suitable syntax for documentation ``+++task:N4JS-35[]+++``.
...
A bug has already been filed... task:AS-35[]
