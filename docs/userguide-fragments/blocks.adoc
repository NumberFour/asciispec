...
For examples of custom AsciiSpec blocks (definition and requirements), refer to the <<AsciiSpec Cheat Sheet>> and for comprehensive documentation, see the AsciiSpec processor file:///Users/brian.smith/N4repos/asciispec/docs/generated-docs/html/spec.html[Specification].
