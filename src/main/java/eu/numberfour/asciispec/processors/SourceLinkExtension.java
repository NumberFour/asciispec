...
/**
 * Registration class for the {@link SourceLinkPreprocessor} processor.
 *
 ...
 */
public class SourceLinkExtension extends ProcessorExtension {
	@Override
	protected void register(JavaExtensionRegistry registry) {
		registry.preprocessor(SourceLinkPreprocessor.class);
	}
}
