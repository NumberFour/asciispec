...
/**
 * Registration class for the {@link MathIncludePreprocessor} processor.
 *
 ...
 */
public class MathIncludeExtension extends ProcessorExtension {
	@Override
	protected void register(JavaExtensionRegistry registry) {
		registry.preprocessor(MathIncludePreprocessor.class);
	}
}
